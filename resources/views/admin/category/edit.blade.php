                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control summernote" name="ar_description">{{$category->ar_description}}</textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="">الوصف انجليزى</label>
                                                                            <textarea class="form-control summernote" name="en_description">{{$category->en_description}}</textarea>
                                                                        </div>
                                                                    </div>
