                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="box-header">
                                          <h3 class="box-title">تفاصيل الكوبون</h3>
                                        </div>
                                            ...
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade in active" id="custom-tabs-one-1"
                                                    ...
                                                    <div class="card card-primary">
                                                        <!-- form start -->
                                                        <form role="form" action="{{route('promo.store')}}"
                                                                ...
                                                                <div class="box-body">
                                                                    ...
                                                                    <div class="col-sm-6 ">
                                                                        {{-- <div class="form-group mt-4"> --}}
                                                                            <input type="radio" name="tab" value="igot3"  checked {{ old('tab') == "igot3" ? 'checked' : '' }}
                                                                            onclick="show3();" /> الكارت
                                                                            <input type="radio" name="tab" value="igotnone"   {{ old('tab') == "igotnone" ? 'checked' : '' }}
                                                                                onclick="show1();" /> تصنيف
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="date"
                                                                                ...
                                                                                name="expired_date" class="form-control" id="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for=""> القيمه</label>
                                                                            <input type="text"
                                                                                value="{{ old('value') }}"
                                                                                name="value" class="form-control" id="">
                                                                        </div>
                                                                    </div>
