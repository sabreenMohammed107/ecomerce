...
@section('content')
            ...
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title">جميع  المدن</h3>
							...
							<td>{{ $index +1 }}</td>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('city.edit', $row->id) }}"><p class=" fa fa-cogs"></p></a>
                  ...
                  <div class="ms-auth-container row">
                    <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                        <div class="form-group">
                            <label  >{{ __('تكلفه الدليفرى') }}</label>
                            <div class="input-group">
                                <input type="number" id="newTitle" name="delivery" class="form-control"
                                   placeholder="تكلفة">
                            </div>
                        </div>
                            </div>
