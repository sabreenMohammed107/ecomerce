<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <!-- logo for regular state and mobile KAPOTCHA devices -->
      <span class="logo-lg"><b>KAP</b>OTCHA</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('webassets/dist/img/user2-160x160.jpg')}}" class="user-image" alt="User Image"/>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ url('edit-user-profile/'.Auth::user()->id) }}" class="btn btn-default btn-flat">Profile</a>
                </div>
