        ...
        <div class="container">
            <div class="row small-gutters">
                <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                    <div id="logo">
                        <a href="{{ LaravelLocalization::localizeUrl('/') }}" ><img src="{{ asset('webassets/img/looogo.PNG') }}" alt=""
                ...
                <div class="col-xl-6 col-lg-7 col-md-6 d-none d-md-block">
                    <form action="{{ route('search-product') }}" method="get">
                        <div class="custom-search-input">
                            <input type="text" name="searchName" placeholder="{{ __('links.search_text') }}">
                    ...
                    <ul class="top_tools">
                                        ...
                                        @foreach ($items as $item)
                                            ...
                                            <li>
                                                <a href="product-detail-1.html">
                                                    <figure><img
                                                            src="{{ asset('uploads/attachment') }}/{{ $item->product->images[0]->img ?? '' }}"
                                                            data-src="{{ asset('uploads/attachment') }}/{{ $item->product->images[0]->img ?? '' }}"
                                                    ...
                                                    <strong><span>
                                                            ...
                                                            @endif
                                                        </span>{{ $item->product->price_after_discount ?? '' }}</strong>
                                                </a>
                                    ...
                                    <div class="total_drop">
                                        ...
                                        @guest
                                            <a href="{{ route('user-login') }}"
                                                class="btn_1 outline">{{ __('links.signin_up') }}</a>
                                        @else
                        ...
                        <li>
                            ...
                            <div class="dropdown dropdown-access">
                                <a href="#" class="wishlist"><span>{{ __('links.wishlist') }}</span></a>
                                <div class="dropdown-menu">
                                    @guest
                                        <a href="{{ route('user-login') }}" class="btn_1">{{ __('links.signin_up') }}</a>
                                    @else
                                        <a href="{{ LaravelLocalization::localizeUrl('/my-fav/' . Auth::user()->id) }}" class="btn_1">{{ __('links.products') }} {{ __('links.wishlist') }}</a>
                        ...
                        <li>
                            <div class="dropdown dropdown-access">
                                <a href="#" class="access_link"><span>{{ __('links.account') }}</span></a>
                                <div class="dropdown-menu">
                                    @guest
                                        <a href="{{ route('user-login') }}" class="btn_1">{{ __('links.signin_up') }}</a>
                                    @else
                                        <a href="#" class="btn_1">{{ Auth::user()->username }}</a>
                                        <ul>
                                            <li>
                                                <a href="{{ route('logout') }}"
