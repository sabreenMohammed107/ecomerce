            ...
            {{-- <div class="col-md-5"> --}}
                        ...
                        <div class="box_account">
                            ...
                            <div class="form_container">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    {{-- / <input type="hidden" name="_token" value="G5P1tC8HYnbP9HknB3R3f2CIMPkdbCNeQesIDvSD">						<div class="form-group"> --}}
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="box_account">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            {{-- <input type="hidden" name="_token" value="G5P1tC8HYnbP9HknB3R3f2CIMPkdbCNeQesIDvSD">                       --}}
                            <div class="form_container">
                                <div class="form-group">
                                ...
                                <div class="private box">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" autocomplete="false"  name="address" value=""
