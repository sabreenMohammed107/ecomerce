...
class FeaturesController extends Controller
{
      ...
      */
     public function __construct(Product_component $object)
     {
    ...
    public function store(Request $request)
    {
        ...
        try
        {
            ...
            Product_component::create($values);
            DB::commit();
    ...
    public function update(Request $request, $id)
    {
        ...
        try
        {
            ...
            Product_component::findOrFail($id)->update($values);
            DB::commit();
            // Enable foreign key checks!
            DB::statement('SET FOREIGN_KEY_CHECKS=1;');
    ...
    {
        $row = Product_component::where('id', '=', $id)->first();
